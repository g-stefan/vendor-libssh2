...
xcopy /Y /S /E "temp\libssh2\include\" "%INSTALL_PATH_DEV%\include\"
copy /Y /B "temp\libssh2\lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
copy /Y /B "temp\libssh2\lib\libssh2.lib" "%INSTALL_PATH_DEV%\lib\ssh2.lib"
